...
import 'package:lunch_partner/controller/profileController.dart';
...
class _UpdateProfileScreen extends State<UpdateProfileScreen> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
      ...
      setState(() {firstNameEditingController.text = ('${loggedInUser.firstName}');
  ...
  updateData(String email, String firstName, String secondName, String phoneNum) async{
    await ProfileController().update(uid, email, firstName, secondName, phoneNum);
  ...
  submitAction(BuildContext context) {
        updateData(emailEditingController.text, firstNameEditingController.text, secondNameEditingController.text, phoneNumEditingController.text);
